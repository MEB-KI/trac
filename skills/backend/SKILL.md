...
5. Keep startup behavior API-only (no schema/data bootstrap during app startup).
6. Prefer migration-first and explicit import workflows (`tud db upgrade`, optional `tud studies import`).
